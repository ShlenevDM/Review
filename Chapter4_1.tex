...
где $E''_n=E+\omega$ -- энергия виртуального электрона.
 ...
 поглощения электрона могут быть получены подстановкой амплитуд~(\ref{Mres}) 
 и~(\ref{Mres12}) в~(\ref{eq:WabsStrongB}) и в случае, когда начальный фотон 
 распространяется поперек магнитного поля, коэффициенты поглощения можно 
