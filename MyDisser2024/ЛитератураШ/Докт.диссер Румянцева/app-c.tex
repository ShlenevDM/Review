...
Аналогично приложению~\ref{Sec:app_a}, факторы ${\cal T}^{s'' s}_{k}$, входящие в~(\ref{eq:amplonever}), приведены для случая отрицательного 
...
согласуются с ранее полученными результатами в  работах~\cite{Latal:86,Kaminker:1992a,Kaminker:1992b}.
