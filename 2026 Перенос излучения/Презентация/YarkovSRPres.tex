...
\begin{frame}{Справка}
	...
	\begin{itemize}
		...
		\item[6.] Размер области с постоянным магнитным полем в дипольном приближении $h_{lfr}\simeq 300 - 100$ м при высотах от 1 до 10 км.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	Удобно использовать томсоновскую оптическую толщу:
	\begin{equation}\nonumber
		\tau_T \simeq  \sigma_T n_e z,
	\end{equation}
	на масштабах которой $\tau = 10^{-4} - 10^{-3}$ можно считать, что только резонансная область даёт вклад в модификацию спектра излучения.
	
	В пределе $\tau \ll \lambda_\text{К}$:
	\begin{equation}\nonumber
...
\begin{frame}
	\begin{figure}\centering
		...
		Функция распределения фотона, усредненная по объему колонки, поляризации фотона, а также по угловому диапазону $x=cos \theta=[0.875, 1)$ при магнитном поле $B=0.05 B_e$ и температуре $T=3$ кэВ, $\tau_{1}=~1~\times 10^{-1}$, что при концентрации $n_e=10^{19} \text{ см}^{-3}$ соответствует $z_1 = z_{\text{max}} \simeq 150$ м . Штриховая линия соответствует результатам, полученным в работе Schonherr:2007, сплошная линия -- дельта-функциональному приближению.
	\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\begin{figure}\centering
		...
		Функция распределения фотона, усредненная по объему колонки, поляризации фотона, а также по угловому диапазону $x=cos \theta=[0.5, 0.625)$ при магнитном поле $B=0.05 B_e$ и температуре $T=3$ кэВ, $\tau_{1}=~1~\times 10^{-1}$, что при концентрации $n_e=10^{19} \text{ см}^{-3}$ соответствует $z_1 = z_{\text{max}} \simeq 150$ м . Штриховая линия соответствует результатам, полученным в работе Schonherr:2007, сплошная линия -- дельта-функциональному приближению.
	\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
	\begin{figure}\centering
		...
		Функция распределения фотона, усредненная по объему колонки, поляризации фотона, а также по угловому диапазону $x=cos \theta=(0, 0.125)$ при магнитном поле $B=0.05 B_e$ и температуре $T=3$ кэВ, $\tau_{1}=~1~\times 10^{-1}$, что при концентрации $n_e=10^{19} \text{ см}^{-3}$ соответствует $z_1 = z_{\text{max}} \simeq 150$ м . Штриховая линия соответствует результатам, полученным в работе Schonherr:2007, сплошная линия -- дельта-функциональному приближению.
	\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
