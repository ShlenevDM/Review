...
\begin{enumerate}
	...
	используется только первое слагаемое в разложении (48).
	\item Приведено явное выражение для квадрата ${\cal S}$-матричного элемента в виде формул (21) и 
(22) и указано, что приближение узкого пика применяется для его преобразования.
	\item Во избежание путаницы с пропагатором было использован отличающийся символ для обозначения 
${\cal S}$-матричного элемента.
	\item Исправлены опечатки в приложении 1.
\end{enumerate}
